...
3. 改进建议""",
    ...
    "regime_recommendation": """解释择势分析与策略推荐的逻辑：
...
四种市场组合：
1. 趋势+趋势: 大盘和个股都在上涨/下跌，方向明确 → 趋势策略（顺势而为）
2. 趋势+震荡: 大盘有方向但个股上下波动 → 均值回归策略（高抛低吸）
3. 震荡+趋势: 大盘横盘但个股走独立行情 → 可尝试趋势策略
4. 震荡+震荡: 都在区间内波动 → 网格交易/RSI（捕捉超买超卖）
